export function WhatsAppIcon({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" className={className} aria-hidden="true">
      ...
      <path d="M12.001 2C6.478 2 2 6.477 2 12c0 1.876.52 3.63 1.42 5.13L2 22l4.995-1.393A9.953 9.953 0 0 0 12.001 22C17.524 22 22 17.523 22 12S17.524 2 12.001 2zm0 18.06a8.02 8.02 0 0 1-4.31-1.253l-.31-.184-3.038.848.827-2.96-.202-.307A8.02 8.02 0 1 1 20.02 12.06a8.02 8.02 0 0 1-8.02 8.001z"/>
    </svg>
  );
}
...
export function TruckIcon({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.8} className={className} aria-hidden="true">
      ...
      <path d="M20 17h2v-3.34a4 4 0 0 0-1.17-2.83L18 8h-4v9h1" />
...
export function MicroscopeIcon({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.8} className={className} aria-hidden="true">
      <path d="M9 18h8M12.5 18v-4M8 14h6l1.5-2.5a3 3 0 0 0-.8-4.1L10 3 6.5 6.4a2 2 0 0 0 .3 3.1L9 11" />
...
export function DiagnosticIcon({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.8} className={className} aria-hidden="true">
      ...
      <path d="M4 12h4l1.5-3 2 6 1.5-3H20" />
    </svg>
  );
}
...
export function TestTubeIcon({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.8} className={className} aria-hidden="true">
      <path d="M9 2 20 13a4.5 4.5 0 0 1-6.36 6.36L2.5 8.25" />
      <path d="M8 8h8" />
      <path d="M2 2l4.5 4.5" />
    </svg>
  );
...
export function BadgeCheckIcon({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.8} className={className} aria-hidden="true">
      <path d="M12 2 14.6 4h3.4v3.4L21 10l-2 2.4L21 15l-3 2.6V21h-3.4L12 23l-2.6-2H6v-3.4L3 15l2-2.4L3 10l3-2.6V4h3.4Z" />
      <path d="m9 12 2 2 4-4" />
    </svg>
  );
}
...
export function UsersIcon({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.8} className={className} aria-hidden="true">
      ...
      <path d="M15.5 14.2c2.8.3 5 2.6 5 5.8" />
    </svg>
  );
}
